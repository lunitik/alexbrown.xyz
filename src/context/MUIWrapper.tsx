...
import { MUILocaleData, supportedLocales } from "../localization/SupportedLocales";
...
export default function MUIWrapper({
  ...
  children: React.ReactNode;
    ...
    const [locale, setLocale] = useState<MUILocaleData>(supportedLocales[currentLocaleIndex]);
  ...
  return (
    <MUIWrapperContext.Provider value={{
